...
// Contexte : s'exécute après que le DOM soit prêt.
// Si tu n'as pas déjà un DOMContentLoaded, ajoute-le :
document.addEventListener('DOMContentLoaded', () => {
  ...
  function openSnakeModal() {
    ...
    // [Étape 3] Initialisation du jeu (placeholder)
    ...
    if (!window.snake) {
      const options = {
        ...
        speedStepEvery: 2,
        maxSpeed: 14,
        assetsPath: 'images/snake/', // <-- ajuste ce chemin selon l'endroit où sont tes PNG
  ...
  function closeSnakeModal() {
    ...
    // [Étape 3] Pause/stop du jeu (placeholder)
  ...
  // Fermeture par clic sur l'overlay (mais pas si on clique dans la boîte)
  ...
  // Rejouer (pour l'instant, juste un feedback; on branchera à l'étape 3)
  btnRestart?.addEventListener('click', () => {
    // [Étape 3] Reset et start
    btnRestart?.addEventListener('click', () => {
  ...
  // À l'étape 3, on gérera devicePixelRatio pour la netteté du rendu.
});
